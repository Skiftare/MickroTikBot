...
- [ ] дз2: добавление БД, регситрации пользователя.
- [ ] дз3: dataflow между БД и роутером
- [ ] дз4: MVP
- [ ] дз5: добавление оплаты в криптовалюте
- [ ] дз6: создание сущности "профиля" в боте (т.е. у пользователя будет ещё и личный кабинет, он когда-то пополняет наш кошелек, и мы это помним), обновление БД под оплату.
