...
public record ClientTransfer(
    ...
    public ClientTransfer(Long tgUserId, String phone, String name, Date userLastVisited, String vpnProfile,
                          Boolean isVpnProfileAlive, Date expiredAt) {
        this(null, tgUserId, phone, name, userLastVisited, vpnProfile, isVpnProfileAlive, expiredAt,
                false, "0", BigDecimal.ZERO);
    }

    @SuppressWarnings("ParameterNumber")
    public ClientTransfer(Long id, Long tgUserId, String phone, String name, Date userLastVisited, String vpnProfile,
                          Boolean isVpnProfileAlive, Date expiredAt) {
